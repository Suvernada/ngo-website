...
import director3 from "../images/Rohit.jpeg";
import teamMember1 from "../images/Shefali.png";
import teamMember2 from "../images/Alpana.jpeg";
      ...
      <section id="about-us">
        <div className="container">
          ...
          <div className="row" style={{ padding: "50px 0" }}>
            <div className="col-lg-6 col-md-12">
              ...
              <p>
                ...
                Journal of Agro Nutrifood Practices and as a subject editor of
                ...
                Nature. Her academic contributions include 90 research papers,
                42 popular articles, and the filing of six patents.
              </p>
              <p>
          ...
          <div className="row" style={{ padding: "50px 0" }}>
            <div className="col-lg-6 col-md-12">
              <p>
                Mr. Rohit Goswami is a professional trainer and Director of
                Beevibes Business Services Pvt. Ltd. and Suvernada Foundation.
                He holds firstclass MBA (Finance and Operation Management) and
                B.Com from Swami Vivekanand Subharti University and Delhi
                University respectively. His extensive experience spans various
                domains including Finance and Accounting, Business Management
                and Business Laws. He is lean certified and has extensive
                experiences of working with renowned multinational corporations
                like Genpact, Merchserve, Perfect Accounting and Shared Services
                and Quatrro Business Support Services contributing significantly
                to their financial success. He has undergone advanced training
                in Microsoft Excel, machine learning and data science. He has
                worked as Process trainer in the corporate world. Now, he is now
                working as a professional trainer. He has extensive experience
                in team handling and capacity building. With his extensive
                expertise and years of experience, he is dedicated to empower
                students with the essential skills and knowledge required for
                effective data analysis and management.
              </p>
              <p>
                Known for his meticulous attention to detail and analytical
                prowess, he has consistently delivered innovative solutions to
                complex business challenges. Mr. Rohit Goswami's exceptional
                managerial skills have been instrumental in driving
                organizational growth and optimizing operational efficiency. He
                has a proven track record of leading high-performing teams,
                fostering a collaborative work environment, and achieving
                remarkable results. In addition to his professional
                accomplishments, Mr. Rohit Goswami is a strong advocate for
                continuous learning and personal development. He actively seeks
                opportunities to expand his knowledge and stay updated with the
                latest industry trends. This commitment to growth reflects his
                dedication to delivering the highest standards of excellence in
                his work. As a professional with a strong ethical foundation,
                Mr. Rohit has consistently upheld the highest standards of
                integrity and transparency. He possesses excellent communication
                and interpersonal skills, enabling him to build strong
                relationships with clients, stakeholders, and team members. His
                extensive expertise, exceptional leadership abilities, and
                unwavering commitment to excellence make him a highly respected
                and sought-after professional in the finance industry.
              </p>
            </div>
            <div className="col-lg-6 col-md-12 text-center">
              <img src={director3} className="img-fluid" alt="director-1" />
              <h6>
                Mr. Rohit Goswami
                <br />
                Director, Suvernada Foundation
          ...
          <div className="section-heading text-center mb-4" style={{ padding: "50px 0 20px" }}>
              <h2>Our Core team</h2>
          ...
          <div className="row" style={{ padding: "0px 0 50px" }}>
            <div className="col-lg-6 col-md-12 text-center">
              ...
              Ms. Shefali Srivastava,
                ...
                <br />
                <a href="mailto:shefali.suvernada.foundation@gmail.com">shefali.suvernada.foundation@gmail.com</a>
              </h6>
            </div>
            <div className="col-lg-6 col-md-12">
              <p>
          ...
          <div className="row" style={{ padding: "50px 0" }}>
            <div className="col-lg-6 col-md-12">
              <p>
              Dr. Alpana Joshi holds a PhD in Human Nutrition from G. B. Pant University of Agriculture &Technology Pantnagar, Uttarakhand. She is a NET qualified candidate and a professional nutritionist with extensive experience in nutrition and weight management consultation at prominent health care centers like Dr. Shikha's clinic, Nutrihealth Systems in New Delhi. Her educational background includes a Master's degree in Home Science (Foods & Nutrition) from Rajasthan University and a Bachelor's degree in Home Science from Maharani College, Jaipur, Rajasthan. She has also authored two publications. Additionally, for the past two years, she has been operating an online diet consultancy service. 
              </p>
            </div>
            <div className="col-lg-6 col-md-12 text-center">
              <img src={teamMember2} className="img-fluid" alt="director-1" />
              <h6>
              Dr. Alpana Joshi
                <br />
