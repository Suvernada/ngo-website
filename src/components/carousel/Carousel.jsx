    ...
    return (
        <>
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        ...
                        <div className="carousel-caption d-none d-md-block text-start">
                            ...
                            <button className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#donationModal">
                                Donate now
                            </button>
                        </div>
                    </div>
            ...
            <div className="d-flex justify-content-evenly flex-wrap mt-3">
                ...
                <a href="https://forms.gle/kRZq13RGvZthwFfK8" className="feedback" style={{ display: "flex" }}>
                    <img src={formpic4} alt="poster" className="feedbackImage" style={{ margin: "0 auto 15px" }} />
                </a>
                <a href="https://forms.gle/kRZq13RGvZthwFfK8" className="feedback" style={{ display: "flex" }}>
                    <img src={formpic5} alt="poster" className="feedbackImage" style={{ margin: "0 auto 15px" }} />
                </a>
                <a href="https://forms.gle/kRZq13RGvZthwFfK8" className="feedback" style={{ display: "flex" }}>
                    <img src={formpic6} alt="poster" className="feedbackImage" style={{ margin: "0 auto 15px" }} />
                </a>
                <a href="https://forms.gle/kRZq13RGvZthwFfK8" className="feedback" style={{ display: "flex" }}>
                    <img src={formpic7} alt="poster" className="feedbackImage" style={{ maxWidth: "100%", margin: "0 auto 15px" }} />
                </a>
                <a href="https://forms.gle/kRZq13RGvZthwFfK8" className="feedback" style={{ display: "flex" }}>
                    <img src={formpic8} alt="poster" className="feedbackImage" style={{ maxWidth: "100%", margin: "0 auto 15px" }} />
                </a>
            </div>
        </>
    );
